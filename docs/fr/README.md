...
Le tableau tient en cinq colonnes :
 -  Le détail dépliable d'un wiki marqué "contenu spammé" liste ses pages en cause, chacune avec un lien qui l'ouvre dans un nouvel onglet, la raison pour laquelle elle est marquée, et ce que le nettoyage en ferait — ou, quand aucune règle ne sait la nettoyer, qu'elle est à regarder à la main
