...
Le tableau tient en cinq colonnes :
 ...
 -  **Actions** : le chevron déplie le détail du wiki (les chiffres en colonnes, la date d'installation, celle de la mesure, et l'activité du wiki sur l'année sous forme de calendrier), le bouton ⋯ ouvre le menu : voir la fiche bazar, l'éditer, mettre à jour vers la version du wiki maître, ajouter ou retirer le compte super admin, et supprimer le wiki — cette dernière entrée ouvre la page de suppression dans un nouvel onglet, en gardant la liste derrière, et cette page rappelle en rouge ce qui va disparaître
