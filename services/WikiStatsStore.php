...
class WikiStatsStore
{
    ...
    public const NUMBERS = ['users', 'forms', 'entries', 'pages', 'lastPageId', 'filesMtime', 'files', 'filesBytes', 'customBytes', 'privateBytes'];
    public const TEXTS = ['lastActivity', 'computedAt', 'checkedAt', 'status', 'error', 'version', 'release'];
